...
def next_step(iter, numant, numcity, etatable, pheromonetable, pathtable, distmat, lengthaver, lengthbest, pathbest, alpha):
    Q = 1
    rho = 0.1  # 信息素的挥发速度
    ...
    return iter, numant, numcity, etatable, pheromonetable, pathtable, distmat, lengthaver, lengthbest, pathbest,alpha;

def main(_):

    numcity = 2000
    coordinates = np.zeros((numcity,2 ))
    ...
    while iter < itermax:
        iter, numant, numcity, etatable, pheromonetable, pathtable, distmat, lengthaver, lengthbest, pathbest, alpha  \
            = next_step(iter, numant, numcity, etatable, pheromonetable, pathtable, distmat, lengthaver, lengthbest, pathbest,alpha)
